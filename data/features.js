...
export const featuresFour = [
  {
    ...
    text: "Experience the world deeply through beautiful settings and thoughtful pacing that feels effortless rather than orchestrated. We prioritize quality over quantity, allowing you to linger in remarkable places and enjoy moments that are natural, unforced, and truly elevated beyond the rush of traditional group travel.",
  },
  {
    id: 2,
    iconSrc: "/img/icons/1/hot-air-balloon.svg",
    title: "Refined Stays",
    text: "Stay in remarkable, distinctive boutique hotels where every detail is chosen with absolute intention. From tranquil resorts to polished city stays, we focus on a relaxed luxury that is felt through the flow of the journey and the quality of the environment rather than through formality or excess.",
  },
  {
    id: 3,
    iconSrc: "/img/icons/1/diamond.svg",
    title: "Flexible Framework",
    text: "Our itineraries provide a solid framework for where we stay and how we move, while leaving plenty of room for personal choice. Whether you prefer guided exploration with expert local insight or space to wander and rest as you see fit, your journey remains seamlessly managed and genuinely human.",
  },
];
