...
const tabs = ["Itinerary", "Accommodations", "Trip Notes", "What's Included","Gallery"];
                    ...
                    <div className="row x-gap-60">
                        ...
                        <div className="col-lg-8 col-12">
                            ...
                            <div className="pt-30">
                                ...
                                {activeTab === 4 && (
                                    <div>
                                        <p className="text-15 text-light-2 mb-30" style={{ lineHeight: "1.85" }}>
                                            A glimpse into what awaits you on this trip.
                                        </p>
