              ...
              <div className="row y-gap-15 justify-between">
                ...
                <div className="col-auto md:d-none">
                  ...
                  >
                    ...
                    <rect y="8" width="4" height="4" fill="#000000" />
                    <rect y="16" width="4" height="4" fill="#000000" />
                    <rect x="8" width="4" height="4" fill="#000000" />
                    <rect x="8" y="8" width="4" height="4" fill="#000000" />
                    <rect x="8" y="16" width="4" height="4" fill="#000000" />
                    <rect x="16" width="4" height="4" fill="#000000" />
