...
export default function CommentBox() {
  return (
    <>
      <h1 className="fw-600 pt-60">Leave a Reply</h1>
      <p className="mt-30">
      ...
      <div className="contactForm y-gap-30 pt-30">
        <div className="row y-gap-30">
          <div className="col-md-6">
            <div className="form-input ">
              ...
              <label className="lh-1 text-light-1">Name</label>
            </div>
          </div>
          ...
          <div className="col-md-6">
            <div className="form-input ">
              ...
              <label className="lh-1 text-light-1">Email</label>
            </div>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-12">
            <div className="form-input ">
              <input type="text" required />
              <label className="lh-1 text-light-1">Title</label>
            </div>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-12">
            <div className="form-input ">
              ...
              <label className="lh-1 text-light-1">Comment</label>
            </div>
          </div>
        </div>
