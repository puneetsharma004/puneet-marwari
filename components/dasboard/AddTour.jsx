...
export default function AddTour() {
  const [activeTab, setActiveTab] = useState("Pay Your Deposit");
  ...
  return (
    <>
      <div className="dashboard__content_content">
        <h1 className="text-30">Pre-Trip Requirements</h1>
                ...
                <div className="tabs__content js-tabs-content">
                  <div
                    className={`tabs__pane  ${
                      activeTab == "Pay Your Deposit" ? "is-tab-el-active" : ""
                    }`}
                  >
                  ...
                  <div
                    className={`tabs__pane  ${
                      activeTab == "Pay Your Balance" ? "is-tab-el-active" : ""
                    }`}
                  >
                    <div className="contactForm row y-gap-30">
                      <div className="col-12">
                  ...
                  <div
                    className={`tabs__pane  ${
                      activeTab == "Emergency Contact" ? "is-tab-el-active" : ""
                    }`}
                  >
                    <div className="contactForm row y-gap-30">
                      <div className="col-12">
                  ...
                  <div
                    className={`tabs__pane  ${
                      activeTab == "Medical Travel Insurance"
                        ? "is-tab-el-active"
                        : ""
                    }`}
                  >
