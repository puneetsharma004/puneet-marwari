...
const reviews = [
    {
        ...
        rating: 5,
        pullQuote: "We will be planning future trips and highly recommend them to others for a fun adventure.",
    ...
    },
    {
        ...
        rating: 5,
        pullQuote: "I've taken 4 trips with Detours Travel. I've introduced friends and referred clients.",
    ...
    },
    {
        ...
        date: "July 2, 2025",
        rating: 5,
        pullQuote: "Iceland in summer is magical — this trip made it unforgettable.",
    ...
    },
    {
        ...
        date: "May 18, 2025",
        rating: 5,
        pullQuote: "Morocco is overwhelming on your own — with a great group, it's pure magic.",
    ...
    },
    {
        ...
        date: "April 3, 2025",
        rating: 5,
        pullQuote: "The safari on day six — I will never forget it for the rest of my life.",
    ...
    },
    {
        ...
        date: "March 30, 2025",
        rating: 5,
        pullQuote: "Japan is already incredible — having the right people with you makes it perfect.",
...
export default function TripReviews() {
    ...
    return (
        <>
            {/* Hero */}
            <CommonHero title="Trip Reviews" subtitle="Real People, Real Experiences" image="/heroimg/trip-reviews.jpg" breadcrumb="Trip Reviews" />
                ...
                <div className="container">
                    <div className="">
                        <div className="">
                            ...
                            {/* Intro */}
                            <p className="text-14 text-light-2 text-center mb-10" style={{ lineHeight: "1.8" }}>
                                Still have questions about our trips? Hear first-hand feedback from past travelers.
                                We're proud of our growing list of testimonials from people who wanted to share
                                what their experience meant to them.
                            </p>

                            {/* Overall rating */}
                            <div className="d-flex items-center justify-center x-gap-10 mt-20 mb-50">
                                <StarRating count={5} />
                                <p className="text-13 fw-600 uppercase text-dark-1" style={{ letterSpacing: "2px" }}>
                                    5.0 out of 5.0 — {reviews.length}+ verified reviews
                                </p>
                            </div>
                            ...
                            <div className="d-flex flex-column y-gap-50">
                                {paginated.map((review) => (
                                    <div key={review.id}>
                                        ...
                                        {/* Reviewer name + meta */}
                                        <p className="text-14 fw-700 uppercase text-dark-1 mb-5"
                                            style={{ letterSpacing: "2px", fontFamily: "var(--font-caslon), serif" }}>
                                            {review.name} — {review.country}
                                        </p>

                                        <div className="d-flex items-center x-gap-15 mb-15">
                                            <StarRating count={review.rating} />
                                            <span className="text-12 fw-500 text-dark-1" style={{ letterSpacing: "1px" }}>
                                                {review.trip}
                                            </span>
                                            <span className="text-12 text-light-2">— {review.date}</span>
                                        </div>
                                        ...
                                        {/* Separator */}
                                        <span className="mb-50" style={{
                                            display: "block", height: 1,
                                            backgroundColor: "#E7E6E6", marginTop: "40px"
                                        }} />
                                    </div>
                                ))}
                            </div>
                            ...
                            <div className="d-flex justify-center mt-50">
                                <div className="pagination">
                                    ...
                                    <button
                                        ...
                                        style={{
                                            opacity: page === 1 ? 0.3 : 1, marginRight: "10px",
                                    ...
                                    <button
                                        ...
                                        className="pagination__button button -outline-black text-dark-1"
                                        style={{
                                            opacity: page === totalPages ? 0.3 : 1, marginLeft: "10px",
